...
//
// ARCHITECTURE TRUST:
// This plugin is designed to run at the VERY END of the pipeline (Phase 4/5).
// It relies on upstream Gatekeepers (_misc_optm, _pre_reject) to:
// 1. Guarantee q.Question[0] exists and is valid.
// 2. Filter out noisy QTypes (ANY, PTR, HTTPS, etc.).
